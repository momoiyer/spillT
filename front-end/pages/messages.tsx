  ...
  return (
    <section className="flex justify-around p-5 bg-cyan-100 dark:bg-cyan-800 dark:text-white">
      ...
      <article className="basis-1/2">
        ...
        <input type="text" id="first_name" className="bg-cyan-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter message here" />
