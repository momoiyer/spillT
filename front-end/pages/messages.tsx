...
const Messages = () => {
  return (
    <section className="flex justify-around p-3 bg-cyan-100 dark:bg-cyan-800 dark:text-white">
      {/* Left side section with search bar and chat preview */}
      <article className="basis-1/4 bg-white dark:bg-cyan-700 rounded-lg">
        <ChatFriendSearch styleClass="p-5 border-b-[1px]" />
        <ChatPreviewList styleClass="p-5 overflow-y-auto h-[73vh]" />
      </article>
